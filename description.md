...
- the configuration files to run the MDeNM simulations included in the manuscript [mdenm_spike.tar.gz](mdenm_spike.tar.gz); All scripts are based in MDexciteR tutorial [MDexciteR](https://github.com/mcosta27/MDexciteR)
